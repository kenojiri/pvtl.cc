...
export ENV_NAME=haas-\$(hostname | awk -F- '{print \$2}')
export HAAS_PASSWORD="***CHANGEMECHANGEME***"
export DOMAIN_NAME=pez.pivotal.io
#export OM_HOSTNAME="opsmgr-01.\${ENV_NAME}.\${DOMAIN_NAME}"
export OM_HOSTNAME="opsmgr-02.\${ENV_NAME}.\${DOMAIN_NAME}"
export OM_USERNAME="admin"
export OM_PASSWORD=\${HAAS_PASSWORD}
